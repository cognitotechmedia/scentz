...
// Stock-only items can also be sold on wholesale and franchise invoices.
if (!hasColumn('materials', 'retail_price')) db.exec('ALTER TABLE materials ADD COLUMN retail_price REAL NOT NULL DEFAULT 0');
if (!hasColumn('materials', 'wholesale_price')) db.exec('ALTER TABLE materials ADD COLUMN wholesale_price REAL NOT NULL DEFAULT 0');
if (!hasColumn('materials', 'franchise_price')) db.exec('ALTER TABLE materials ADD COLUMN franchise_price REAL NOT NULL DEFAULT 0');
if (!hasColumn('materials', 'gst_rate')) db.exec('ALTER TABLE materials ADD COLUMN gst_rate REAL NOT NULL DEFAULT 18');
